"""
Parsers Package for AI Resume Maker Backend

This package contains modules for extracting and parsing data from various sources:
- file_parser: Extract text from PDF, DOCX, and TXT files
- linkedin_parser: Parse LinkedIn profile information
- github_parser: Parse GitHub profile information using public API
"""
